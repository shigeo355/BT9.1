...
import java.io.*;
import jakarta.servlet.*;          // đổi javax -> jakarta
import jakarta.servlet.http.*;    // đổi javax -> jakarta
...
public class DownloadServlet extends HttpServlet {
    ...
    private String registerUser(HttpServletRequest request,
        ...
        // add a cookie that stores the user's firstName as a cookie
    ...
    private String deleteCookies(HttpServletRequest request,
        ...
        if (cookies != null) {
            for (Cookie cookie : cookies) {
                ...
                cookie.setPath("/"); // allow the download app to access it
